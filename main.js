...
let playerOneColor = 'rgb(86, 151, 255)';

let playerTwo = prompt('Player Two: Enter Your Name, you will be Red.');
let playerTwoColor = 'rgb(237, 45, 73)';
...
// Check if any wins
// Check for horizontal Wins change the col increasing the number increase the difficulty and vise versa
